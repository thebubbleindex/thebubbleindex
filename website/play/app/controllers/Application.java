...
public class Application extends Controller {
  ...
  public static void browselist(String Type) {
			...
			String Types[] ={"Indices","Commodities","Currencies","CompositeFifty","Stocks",
				"Germany","China","Japan","HongKong","UnitedKingdom",
				"Australia","Israel","Singapore","Mexico","Italy","India","Brazil","Argentina",
				"Canada","France","Indonesia","Taiwan","Switzerland","Sweden","Austria","Greece",
				"Norway","Denmark","NewZealand","CompositeEighty", "CompositeNinety",
				"CompositeNinetyFive", "CompositeNinetyNine","SouthKorea","Spain","Netherlands",
				"Russia"};
	...
	public static void searchResults(String search) {
		...
		for (int i = 0; i < splitted.length; i++) {
			...
			List<Currencies> tempthree = Currencies.find("keywords like ?", "%"+splitted[i].toUpperCase()+"%").fetch(12);
			...
			List<Commodities> tempfour = Commodities.find("keywords like ?", "%"+splitted[i].toUpperCase()+"%").fetch(12);
			...
			List<Germany> tempfive = Germany.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".F").fetch(4);
			...
			List<HongKong> tempsix = HongKong.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".HK").fetch(4);
			...
			List<UnitedKingdom> tempseven = UnitedKingdom.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".L").fetch(4);
			...
			List<India> tempeight = India.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".BO").fetch(4);
			...
			List<Brazil> tempnine = Brazil.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".SA").fetch(4);
			...
			List<China> tempten = China.find("keywords like ? or keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".SS", splitted[i].toUpperCase() + ".SZ").fetch(4);
			...
			List<Argentina> temptwelve = Argentina.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".BA").fetch(4);
			...
			List<SouthKorea> tempthirteen = SouthKorea.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".KS").fetch(4);
			...
			List<Australia> tempfourteen = Australia.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".AX").fetch(4);
			...
			List<Israel> tempfifteen = Israel.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".TA").fetch(4);
			...
			List<Singapore> tempsixteen = Singapore.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".SI").fetch(4);
			...
			List<CompositeFifty> tempseventeen = CompositeFifty.find("keywords like ?", "%"+splitted[i].toUpperCase()+"%").fetch(4);
			...
			List<Italy> tempeighteen = Italy.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".MI").fetch(4);
			...
			List<Mexico> tempnineteen = Mexico.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".MX").fetch(4);
			...
			List<Canada> temptwenty = Canada.find("keywords like ? or keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".TO", splitted[i].toUpperCase() + ".V").fetch(4);
			...
			List<France> temptwentyone = France.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".PA").fetch(4);
			...
			List<Indonesia> temptwentytwo = Indonesia.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".JK").fetch(4);
			...
			List<Taiwan> temptwentythree = Taiwan.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".TW").fetch(4);
			...
			List<CompositeEighty> temptwentyfour = CompositeEighty.find("keywords like ?", "%"+splitted[i].toUpperCase()+"%").fetch(4);
			...
			List<CompositeNinety> temptwentyfive = CompositeNinety.find("keywords like ?", "%"+splitted[i].toUpperCase()+"%").fetch(4);
			...
			List<CompositeNinetyFive> temptwentysix = CompositeNinetyFive.find("keywords like ?", "%"+splitted[i].toUpperCase()+"%").fetch(4);
			...
			List<CompositeNinetyNine> temptwentyseven = CompositeNinetyNine.find("keywords like ?", "%"+splitted[i].toUpperCase()+"%").fetch(4);
			...
			List<Switzerland> temptwentyeight = Switzerland.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".SW").fetch(4);
			...
			List<Sweden> temptwentynine = Sweden.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".ST").fetch(4);
			...
			List<Austria> tempthirty = Austria.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".VI").fetch(4);
			...
			List<Greece> tempthirtyone = Greece.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".AT").fetch(4);
			...
			List<Norway> tempthirtytwo = Norway.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".OL").fetch(4);
			...
			List<Denmark> tempthirtythree = Denmark.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".CO").fetch(4);
			...
			List<NewZealand> tempthirtyfour = NewZealand.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".NZ").fetch(4);
			...
			List<Spain> tempthirtyfive = Spain.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".MC").fetch(4);
			...
			List<Netherlands> tempthirtysix = Netherlands.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".AS").fetch(4);
			...
			List<Russia> tempthirtyseven = Russia.find("keywords like ? or keywords like ?", splitted[i].toUpperCase(), splitted[i].toUpperCase() + ".ME").fetch(4);
    	...
    	index.findPlotLocation();
			...
			render(stocksResults, indicesResults, currenciesResults, 
					commoditiesResults, germanyResults, hongkongResults, 
					unitedkingdomResults, indiaResults, brazilResults, chinaResults,
					japanResults, argentinaResults, southkoreaResults, 
					australiaResults, israelResults, singaporeResults, compositefiftyResults,
					italyResults, mexicoResults, canadaResults, franceResults,
					indonesiaResults, taiwanResults, compositeeightyResults,
					compositeninetyResults, compositeninetyfiveResults, 
					compositeninetynineResults, switzerlandResults, swedenResults,
					austriaResults, greeceResults, denmarkResults, norwayResults,
					newzealandResults, spainResults, netherlandsResults, russiaResults, totalFound);
		}
	}      
