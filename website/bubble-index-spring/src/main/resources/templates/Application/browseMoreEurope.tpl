						...
						div(class: 'project-body-container container-24') {
							div(class: 'welcome block') {
								div(class: 'welcome-globe clearfix') {
									...
									a(class: 'left edge top', href: '/browselist/Denmark', 'DENMARK')
									a(class: 'right edge top', href: '/browselist/Norway', 'NORWAY')
									a(class: 'left middle top', href: '/browselist/Austria', 'AUSTRIA')
									a(class: 'right middle top', href: '/browselist/Spain', 'SPAIN')
									a(class: 'left middle bottom', href: '/browselist/Netherlands', 'NETHERLANDS')
									...
									a(class: 'right edge bottom', href: '/browseEurope', 'BACK')
								}
							}
						}
					}
