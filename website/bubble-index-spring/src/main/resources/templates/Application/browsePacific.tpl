...
html(lang:'en') {
	head {     
		title('The Bubble Index - Browse Pacific')
						...
						div(class: 'project-body-container container-24') {
							div(class: 'welcome block') {
								div(class: 'welcome-globe clearfix') {
									...
									a(class: 'left edge top', href: '/browselist/Japan', 'JAPAN')
									a(class: 'right edge top', href: '/browselist/Australia', 'AUSTRALIA')
									a(class: 'left middle top', href: '/browselist/Indonesia', 'INDONESIA')
									a(class: 'right middle top', href: '/browselist/SouthKorea', 'SOUTH KOREA')
									a(class: 'left middle bottom', href: '/browselist/Taiwan', 'TAIWAN')
									a(class: 'right middle bottom', href: '/browselist/NewZealand', 'NEW ZEALAND')
