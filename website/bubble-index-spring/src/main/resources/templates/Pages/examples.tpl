					...
					div(class: 'project-body-container container-24') {
						div(class: 'project-body block') {
							...
							div(class: 'project-description') {
								...
								p() {
									a(class: 'text-colorful', href: 'https://cdn.thebubbleindex.com/PDF/Indices/DJIA/DJIA.pdf', 'Black Thursday')
								}
								...
								p() {
									a(class: 'text-colorful', href: 'https://cdn.thebubbleindex.com/PDF/Indices/DJIA/DJIA.pdf', 'Black Monday')
								}
								...
								p() {
									a(class: 'text-colorful', href: 'https://cdn.thebubbleindex.com/PDF/Indices/DJIA/DJIA.pdf', "Late 90's")
								}
								...
								p() {
									a(class: 'text-colorful', href: 'https://cdn.thebubbleindex.com/PDF/Indices/DJIA/DJIA.pdf', "The Great Recession")
								}
								...
								p() {
									a(class: 'text-colorful', href: 'https://gateway.ipfs.io/ipns/QmPC1xcsMTDKFTWHLrGEaNTCEdceUf4wWRJhM5P4kDeUsv/page/3dcontourexamples', '3D Contour')
								}
